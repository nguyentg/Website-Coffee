...
<body>
	...
	<div class="contact py-5">
		<div class="container py-xl-5 py-lg-3">
			<h5 class="tittle-w3 text-dark text-center mb-5">Login</h5>
			<div class="row contact-us1-bottom">
				<div class="col-lg-6">
					<form method="POST" action="${pageContext.request.contextPath}/dangnhap">
						<div class="form-group">
							<input type="text" placeholder="Số điện thoại" name="sodienthoaidangnhap" class="form-control" required="">
						</div>
						<div class="form-group">
							<input type="password" placeholder="Mật khẩu" name="matkhaudangnhap" class="form-control" required="">
						</div>
						<li>
							<a href="${pageContext.request.contextPath}/DangKy" class="">Create Account</a>
						</li>

...
<body>
	...
	<nav aria-label="breadcrumb">
	    <ol class="breadcrumb">
	        <li class="breadcrumb-item">
	            <a href="${pageContext.request.contextPath}/TrangChu">Home</a>
	        </li>
	...
	<div class="contact py-5">
	    <div class="container py-xl-5 py-lg-3">
	        <h5 class="tittle-w3 text-dark text-center mb-5">Registration</h5>
	        <div class="row contact-us1-bottom">
	            <div class="col-lg-6">
	                <form method="POST" action="${pageContext.request.contextPath}/DangKy">
	                    <div class="form-group">
	                        <input type="text" placeholder="Số điện thoại" name="sodienthoai" class="form-control" required="">
	                    </div>
	                    <div class="form-group">
	                        <input type="password" placeholder="Mật khẩu" name="matkhau" class="form-control" required="">
	                    </div>
	                    <div class="form-group">
	                        <input type="text" placeholder="Tên người dùng" name="tenkhach" class="form-control" required="">
	                    </div>
